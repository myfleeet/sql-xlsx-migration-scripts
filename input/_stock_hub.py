...
mock_query_response = dict(
  vin='', make='', model='', version='', cif='', hub_name='', location='', status='', created_at='', license_plate='', color='', shift='', fuel_type=''
)
...
def serialized_data(elm = mock_query_response):
  return {
    ...
    # debería haber CIF Asignado si está en HUB? 
    'nif_de_cliente': '🔴', 
